...
WITH quoteData AS (
    SELECT
        ...
        Q.ExpireDate AS QuoteExpiryDate,
        Q.PetBirthdate,
...
SELECT 
	'Petcover' Brand,
    PolicyCreatedDate,                         
	QuoteNumber, CreatedDate, QuoteStartDate, QuoteExpiryDate, QuoteReceivedMethod, PolicyNumber, PolicyStartDate, PolicyEndDate,
